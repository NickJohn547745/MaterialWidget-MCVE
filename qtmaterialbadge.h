...
class QtMaterialBadge : public QtMaterialOverlayWidget
{
    ...
    Q_PROPERTY(qreal relativeXPosition WRITE setRelativeXPosition READ relativeXPosition)
    Q_PROPERTY(qreal relativeYPosition WRITE setRelativeYPosition READ relativeYPosition)
